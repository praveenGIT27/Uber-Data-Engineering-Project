...
def transform(data, *args, **kwargs):
    """
    Transforms raw Uber trip data into a star schema:
    - 1 fact table
    - 7 dimension tables: datetime, passenger_count, trip_distance,
      rate_code, pickup_location, dropoff_location, payment_type
    """
